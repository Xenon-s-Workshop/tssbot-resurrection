"""TSS Bot - Main Entry Point WITH PROPER CLEANUP"""
import asyncio
...
pdf_processor = PDFProcessor(api_rotator)
            ...
            try:
                ...
                if task:
                    ...
                    try:
                        ...
                        try:
                            await task_data['context'].bot.send_message(user_id, f"❌ Failed: {str(e)[:200]}")
                        except:
                            pass
                    finally:
...
def main():
    ...
    bot_handlers = BotHandlers(pdf_processor)
    ...
    print(f"  Auth: {'on' if config.AUTH_ENABLED else 'off'}")
